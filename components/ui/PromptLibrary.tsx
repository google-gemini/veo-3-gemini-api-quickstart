...
import { Book, Trash2, Plus, X, Check } from "lucide-react";
                        ...
                        <div className="p-3 border-b border-slate-100 dark:border-slate-800">
                            {isSaving ? (
                                ...
                                <button
                                    ...
                                    className="w-full flex items-center justify-center gap-2 py-1.5 text-sm bg-indigo-50 dark:bg-indigo-900/20 text-indigo-600 dark:text-indigo-400 rounded hover:bg-indigo-100 dark:hover:bg-indigo-900/40 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                                >
